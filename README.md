...
> Status: **public beta** (v1.0.0-beta.11). Cross-platform
> (Windows / macOS / Linux), Zotero 7+, [AGPL-3.0](LICENSE).
>
> **Install:** download **[`obsidian-notepad-for-zotero.xpi`](https://github.com/Acatechnic/obsidian-notepad-for-zotero/releases/download/v1.0.0-beta.11/obsidian-notepad-for-zotero.xpi)**
...
1. Download **[`obsidian-notepad-for-zotero.xpi`](https://github.com/Acatechnic/obsidian-notepad-for-zotero/releases/download/v1.0.0-beta.11/obsidian-notepad-for-zotero.xpi)**
